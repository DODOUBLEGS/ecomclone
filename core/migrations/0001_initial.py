    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.shoptype')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            model_name='category',
            name='shop_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.shoptype'),
        ),
        migrations.CreateModel(
            name='Wishlist',
            fields=[
